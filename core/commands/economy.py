...
class Economy(commands.Cog, description="Buying Bitcoin and NFTs with these!"):
    ...
    @commands.is_owner()
    async def addmoney(self, ctx:commands.Context, amount:int=commands.Option(description="The amount you want give"), user:discord.User=commands.Option("The user you want to give the amount to", default=None):
