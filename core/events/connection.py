...
class OnReady(commands.Cog):
    ...
    async def on_ready(self):
        ...
        await self.bot.change_presence(status=discord.Status.dnd, activity=discord.Activity(type=discord.ActivityType.watching, name=F"over Sym {len(self.bot.guilds)} | .shelp"))
